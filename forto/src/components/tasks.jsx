        ...
        <div className="popup-overlay">
          <div className="popup-window">
            ...
            <div className="date-shortcuts">
              <button
                type="button"
                className={newTask.date === todayISO ? "active-date-shortcut" : ""}
                onClick={() => setNewTask({ ...newTask, date: todayISO })}
              >
                Today
              </button>
              <button
                type="button"
                className={newTask.date === tomorrowISO ? "active-date-shortcut" : ""}
                onClick={() => setNewTask({ ...newTask, date: tomorrowISO })}
              >
                Tomorrow
              </button>
            </div>
            ...
            <div className="popup-buttons">
              <button className="popup-add" onClick={addTask}>
                Add
              </button>
        ...
        <div className="popup-overlay">
          <div className="popup-window">
            ...
            <input
              ...
              onChange={(e) => handleInputChange(e, setEditTask)}
            />
            <textarea
              name="description"
              placeholder="Description"
            ...
            <div className="popup-buttons">
              ...
              <button className="popup-cancel" onClick={() => setShowEditTask(false)}>
                Cancel
              </button>
            </div>
          </div>
